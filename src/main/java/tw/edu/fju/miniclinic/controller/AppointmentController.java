...
public ResponseEntity<Appointment> createAppointment(
    ...
    public String stats(Model model) {
        ...
        model.addAttribute("appointmentsByDepartment", appointmentRepo.countAppointmentsByDepartment());
        return "stats";
    }
    ...
    public ResponseEntity<List<Appointment>> getAppointments(
        ...
        if (date != null && !date.isBlank()) {
            ...
            filtered = appointmentRepo.findByApptDate(apptDate);
        } else {
            filtered = appointmentRepo.findAll();
        }
        ...
        if (doctorId != null && !doctorId.isBlank()) {
            ...
            if (date == null || date.isBlank()) {
                return ResponseEntity.ok(appointmentRepo.findByDoctor(doctor.get()));
            }
            return ResponseEntity.ok(filtered.stream()
                    .filter(appt -> appt.getDoctor().getDoctorId().equals(doctorId))
                    .toList());
        }
